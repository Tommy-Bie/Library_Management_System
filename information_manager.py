...
class Ui_systemadmin(object):
    def setupUi(self, systemadmin):
        ...
        systemadmin.resize(738*2-50, 747)

        # 显示华南理工大学校徽
        lb1 = QLabel(self)
        lb1.setGeometry(730, 20, 1300, 700)
    ...
    def retranslateUi(self, systemadmin):
        ...
        systemadmin.setWindowTitle(_translate("systemadmin", "信息管理员系统 Information Management"))
        ...
        self.unit.setItemText(0, _translate("systemadmin", "研究生一班"))
        self.unit.setItemText(1, _translate("systemadmin", "本科生一班"))
        self.unit.setItemText(2, _translate("systemadmin", "研究生二班"))
        self.unit.setItemText(3, _translate("systemadmin", "智能科学专业"))
        ...
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab), _translate("systemadmin", "读者信息ReaderInfo"))
        ...
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_2), _translate("systemadmin", "图书管理员信息LibInfo"))
    ...
    def displayadmininfo(self):
        ...
        self.adminpassword.setText(self.admininfos.item(s, 2).text())
